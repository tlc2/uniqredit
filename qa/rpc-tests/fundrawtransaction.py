...
class RawTransactionsTest(UniqreditTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid uniqredit address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid uniqredit address" in e.error['message'])
