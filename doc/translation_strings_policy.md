...
This document provides guidelines for internationalization of the Uniqredit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `uniqredit_en.ts` remains unchanged.
