Uniqredit Core version 0.9.4 is now available from:

  https://uniqredit.org/bin/0.9.4/
...
this update is incompatible with the Uniqredit system and could lead to consensus
forks.

Uniqredit Core released binaries from https://uniqredit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~uniqredit/+archive/ubuntu/uniqredit
- A third-party or self-compiled Uniqredit Core

upgrade to Uniqredit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
