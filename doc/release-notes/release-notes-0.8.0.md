Uniqredit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/uniqredit/files/Uniqredit/uniqredit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Uniqredit
...
New/changed settings (command-line or uniqredit.conf file)
--------------------------------------------------------
