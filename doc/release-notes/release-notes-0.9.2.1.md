Uniqredit Core version 0.9.2.1 is now available from:

  https://uniqredit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 UNIQ to 0.01 UNIQ
...
- Fix "Start uniqredit on system login"
