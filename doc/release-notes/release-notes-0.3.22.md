Download URL: https://sourceforge.net/projects/uniqredit/files/Uniqredit/uniqredit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 UNIQ fee schedule (users still pay 0.01 UNIQ per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #uniqredit00 - #uniqredit99
