Uniqredit Core version 0.10.4 is now available from:

  <https://uniqredit.org/bin/uniqredit-core-0.10.4/>
...
- #6953 `43c2789` Split uniqredit-tx into its own package
- #6953 `dfe0d4d` Include uniqredit-tx binary on Debian/Ubuntu
