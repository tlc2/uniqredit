Uniqredit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/uniqredit/files/Uniqredit/uniqredit-0.5.4/
...
http://gitorious.org/uniqredit/uniqreditd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Uniqredit-Qt notifications under Growl 1.3.
Increase required age of Uniqredit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUniqredit properly when installing Uniqredit-Qt over it. (Windows)
