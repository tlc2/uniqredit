...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/uniqredit/uniqredit/blob/master/doc/translation_process.md#synchronising-translations).
...
```
uniqredit-${VERSION}-aarch64-linux-gnu.tar.gz
uniqredit-${VERSION}-arm-linux-gnueabihf.tar.gz
uniqredit-${VERSION}-i686-pc-linux-gnu.tar.gz
uniqredit-${VERSION}-x86_64-linux-gnu.tar.gz
...
space *do not upload these to the uniqredit.org server, nor put them in the torrent*.
