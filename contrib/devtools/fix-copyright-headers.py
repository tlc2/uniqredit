...
// Copyright (c) 2009-2012 The Uniqredit Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Uniqredit/$1-%s The Uniqredit/' %s"
REGEX_CURRENT= re.compile("%s The Uniqredit" % year)
