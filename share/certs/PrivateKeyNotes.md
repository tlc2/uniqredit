...
unlocked to sign the Uniqredit-Qt.app bundle.
...
allowing somebody to distribute a Uniqredit-Qt.app or uniqredit-qt-setup.exe with a valid
...
that the uniqredit-qt.exe file inside the installer had not been tampered with.
