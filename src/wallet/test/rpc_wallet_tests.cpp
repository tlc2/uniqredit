// Copyright (c) 2013-2015 The Uniqredit Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CUniqreditAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CUniqreditAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CUniqreditAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CUniqreditAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CUniqreditAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CUniqreditAddress(arr[0].get_str()).Get() == demoAddress.Get());
