...
#ifndef UNIQREDIT_TEST_SCRIPTNUM10_H
#define UNIQREDIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Uniqredit Core 0.10.0, for cross-comparison.
 */
public:
