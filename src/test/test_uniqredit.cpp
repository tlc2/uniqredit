...
#define BOOST_TEST_MODULE Uniqredit Test Suite

#include "test_uniqredit.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_uniqredit_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
