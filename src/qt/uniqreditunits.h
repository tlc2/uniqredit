...
#ifndef UNIQREDIT_QT_UNIQREDITUNITS_H
#define UNIQREDIT_QT_UNIQREDITUNITS_H
...
/** Uniqredit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UniqreditUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UniqreditUnits(QObject *parent);

    /** Uniqredit units.
      @note Source: https://en.uniqredit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        UNIQ,
...
typedef UniqreditUnits::Unit UniqreditUnit;

#endif // UNIQREDIT_QT_UNIQREDITUNITS_H
