...
#include "config/uniqredit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatUniqreditURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + UniqreditUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatUniqreditURI(info));
}
