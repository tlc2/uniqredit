...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(UniqreditUnits::UNIQ),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = UniqreditUnits::formatWithUnit(unit, amount, true, UniqreditUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(UniqreditUnits::formatWithUnit(unit, balance, false, UniqreditUnits::separatorAlways));

    QString bal = ui->labelBalance->text();
    someFunctionThatChangesText(bal);
 
     //ui->labelUnconfirmed->setText(UniqreditUnits::formatWithUnit(unit, unconfirmedBalance, false, UniqreditUnits::separatorAlways));
    //ui->labelImmature->setText(UniqreditUnits::formatWithUnit(unit, immatureBalance, false, UniqreditUnits::separatorAlways));
    //ui->labelTotal->setText(UniqreditUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, UniqreditUnits::separatorAlways));
    //ui->labelWatchAvailable->setText(UniqreditUnits::formatWithUnit(unit, watchOnlyBalance, false, UniqreditUnits::separatorAlways));
    //ui->labelWatchPending->setText(UniqreditUnits::formatWithUnit(unit, watchUnconfBalance, false, UniqreditUnits::separatorAlways));
   //ui->labelWatchImmature->setText(UniqreditUnits::formatWithUnit(unit, watchImmatureBalance, false, UniqreditUnits::separatorAlways));
    //ui->labelWatchTotal->setText(UniqreditUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, UniqreditUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("UNIQ")
    updateDisplayUnit();
}
